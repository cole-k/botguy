...
class BotGuyBot extends botbuilder_1.ActivityHandler {
    constructor() {
        ...
        this.onMessage((context, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            botbuilder_core_1.TurnContext.getMentions(context.activity).forEach((mention) => console.log(`Mentioned ${mention.mentioned.name} (id ${mention.mentioned.id}), ${Object.entries(mention.mentioned)}`));
